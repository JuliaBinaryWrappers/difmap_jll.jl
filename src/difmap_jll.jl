...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import difmap_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("43cd2700-e54a-5645-adf8-b9b288a87fe6"))
platforms = [Pkg.Artifacts.unpack_platform(e, "difmap", artifacts_toml) for e in artifacts["difmap"]]
...
if best_platform === nothing
    @debug("Unable to load difmap; unsupported platform $(triplet(platform_key_abi()))")
else
